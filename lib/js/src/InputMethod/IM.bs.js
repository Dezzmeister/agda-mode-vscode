...
function lockEditor(t) {
  t.editorLock = true;
}

function unlockEditor(t) {
  t.editorLock = false;
}

function isEditorLocked(t) {
  return t.editorLock;
}
...
exports.run = run;
exports.lockEditor = lockEditor;
exports.unlockEditor = unlockEditor;
exports.isEditorLocked = isEditorLocked;
